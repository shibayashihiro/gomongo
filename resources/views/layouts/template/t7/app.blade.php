...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t7/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t7/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#0988FF'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#B988FF'}};
        }
    </style>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/plugins/css/plugins.bundle.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t7/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t7/css/custome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t7/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t7/css/responsive.css')}}">
...
<body>
<header id="header">
    @include('layouts.template.t7.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t7.footer')
</footer>
...
<script src="{{asset('assets/web/template/t7/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t7/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t7/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t7/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t7/js/header.js')}}"></script>
