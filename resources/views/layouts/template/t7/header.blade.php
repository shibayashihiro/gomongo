            ...
            <div class="head-bottom">
                ...
                <nav class="nav-menu">
                    ...
                    <ul class="menu">
                        ...
                        <li><a href="javascript:;">Serach List</a></li> --}}
                    </ul>
                </nav>
                <a href="{{ route('front.template.home', $domain_slug) }}" class="wd-sl-logo"><img
                ...
                <a href="{{ route('front.template.home', $domain_slug) }}" class="wd-sl-logoblue"><img
                        src="{{ checkFileExist(get_web_content_detail($web_content->id, $web_content->template, 'common', 'header', 'logo')) }}"
                        alt="" class="common_header_logo wd-logo"></a>
                @if (is_login_for_edit() == 1)
                    <div class="wd-edit-header-t7">
