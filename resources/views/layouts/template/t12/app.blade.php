...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t12/vendors/bootstrap/css/bootstrap.min.css')}}">

    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t12/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t12/vendors/slick/slick.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t12/vendors/slick/slick-theme.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#FEC556'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#AEC556'}};
        }
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t12/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t12/css/custome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t12/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t12/css/responsive.css')}}">
...
<header id="header" class="fixed-top">
    @include('layouts.template.t12.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t12.footer')
</footer>
...
<script src="{{asset('assets/web/template/t12/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t12/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t12/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<script src="{{asset('assets/web/template/t12/vendors/slick/slick.js')}}"></script>
<script src="{{asset('assets/web/template/t12/vendors/slick/mousewheel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t12/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t12/js/header.js')}}"></script>
