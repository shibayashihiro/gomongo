...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t14')}}/vendors/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t14')}}/vendors/owl.carousel/css/owl.carousel.min.css">
    <!-- fontawesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css">
    <!-- Custome CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t14')}}/css/header_footer.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t14')}}/css/edit.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t14')}}/css/style.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t14')}}/css/custome.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t14')}}/css/responsive.css">

    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#F38C08'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#052F71'}};
        }
...
<header id="header1" class="fixed-top">
    @include('layouts.template.t14.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t14.footer')
</footer>
...
<!-- Bootstrap JS & Jquery -->
<script src="{{asset('assets/web/template/t14')}}/vendors/jquery/jquery.min.js"></script>
...
<script src="{{asset('assets/web/template/t14')}}/vendors/bootstrap/js/bootstrap.min.js"></script>
<script src="{{asset('assets/web/template/t14')}}/vendors/owl.carousel/js/owl.carousel.js"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t14')}}/js/main.js"></script>
<script src="{{asset('assets/web/template/t14')}}/js/header.js"></script>
