...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t5/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t5/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#EA001E'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'rgba(234, 0, 30, 0.1)'}};
        }
    </style>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/plugins/css/plugins.bundle.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t5/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t5/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t5/css/responsive.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t5/css/custome.css')}}">
...
<body>
<header id="header">
    @include('layouts.template.t5.header')

</header>
<!-- MAIN SECTIONS -->

<main class="home-page {{ (Request::segment(3) == 'stock-list')?'stocklist-page':''}}">
    @yield('content')
</main>
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t5.footer')
...
<script src="{{asset('assets/web/template/t5/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t5/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t5/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t5/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t5/js/header.js')}}"></script>
