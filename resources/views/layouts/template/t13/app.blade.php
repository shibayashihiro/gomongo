...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t13/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t13/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#191D3A'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#3A92FB'}};
        }
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t13/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t13/css/custome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t13/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t13/css/responsive.css')}}">
...
<header id="header1" class="fixed-top">
    @include('layouts.template.t13.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t13.footer')
</footer>
...
<script src="{{asset('assets/web/template/t13/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t13/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t13/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t13/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t13/js/header.js')}}"></script>
