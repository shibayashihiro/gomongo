...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t18/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t18/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#4F0E20'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#FFD7B0'}};
        }
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t18/vendors/slick/slick.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t18/vendors/slick/slick-theme.css')}}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t18/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t18/css/edit.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t18/css/custome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t18/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/css/compose.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t18/css/responsive.css')}}">
...
<header id="header1" class="fixed-top">
    @include('layouts.template.t18.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t18.footer')
</footer>
...
<script src="{{asset('assets/web/template/t18/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t18/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t18/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t18/js/range-slider.js')}}"></script>
<script src="{{asset('assets/web/template/t18/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t18/js/header.js')}}"></script>
