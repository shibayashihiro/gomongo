...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t1/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
    ...
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#DC7000'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color: '#8C7000'}};
        }
    </style>
...
<body>
<header id="header">
    @include('layouts.template.t1.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t1.footer')
</footer>
...
<!-- Bootstrap JS & Jquery -->
<script src="{{asset('assets/web/template/t1/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t1/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t1/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<script src="{{asset('assets/web/template/t1/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t1/js/header.js')}}"></script>
