...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t11/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t11/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t11/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t11/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t11/css/custome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t11/css/responsive.css')}}">
...
<header id="header" class="fixed-top">
    @include('layouts.template.t11.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t11.footer')
</footer>
...
<script src="{{asset('assets/web/template/t11/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t11/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t11/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t11/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t11/js/header.js')}}"></script>
