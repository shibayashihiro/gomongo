        ...
        <div class="row footer-cont">
            <div class="col-lg-4 col-md-12 f-logo">
                @if(is_login_for_edit() == 1)
                    <a class="wd-edit-btn"
                       href="javascript:;"
                       onclick="getDynamicModal('{{$web_content->id}}','{{$web_content->template}}','common','footer',{{json_encode(['Footer Text'=>'textarea','Footer Logo'=>'file'])}})"><img
                ...
                <div class="subscribe">
                    ...
                    <div class="subscribe-row">
                        <input type="text">
                        <button class="y-btn"><i class="far fa-paper-plane"></i></button>
                    </div>
                </div>
            </div>
    ...
    'Contact number'=>'text'
                ...
                <div class="nob-row">
                    ...
                    <div class="nb-box">
                        <p>Vat Number</p>
                        <a href="#"
                           class="common_footer_vat_number">{{get_web_content_detail($web_content->id, $web_content->template, 'common', 'footer', 'vat_number')}}</a>
                    </div>
                </div>
                <div class="nob-row">
                    <i class="fas fa-phone-alt"></i>
                    <div class="nb-box">
                        <p>CR NUMBER</p>
                        <a href="#"
                           class="common_footer_company_registration_number">{{get_web_content_detail($web_content->id, $web_content->template, 'common', 'footer', 'company_registration_number')}}</a>
                    </div>
                </div>
                <div class="nob-row">
                    <i class="fas fa-phone-alt"></i>
                    <div class="nb-box">
                        <p>FCA number</p>
                        <a href="#"
                           class="common_footer_fca_number">{{get_web_content_detail($web_content->id, $web_content->template, 'common', 'footer', 'fca_number')}}</a>
                    </div>
                </div>
                <div class="nob-row">
