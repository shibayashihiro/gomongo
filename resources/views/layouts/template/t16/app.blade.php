...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t16')}}/vendors/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t16')}}/vendors/owl.carousel/css/owl.carousel.min.css">
    <!-- fontawesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css">
    <!-- Custome CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/plugins/css/plugins.bundle.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t16')}}/css/header_footer.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t16')}}/css/edit.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t16')}}/css/style.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t16')}}/css/custome.css">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t16')}}/css/responsive.css">
    ...
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#2cd09d'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#3AEFB7'}};
        }
...
<header id="header" class="fixed-top">
    @include('layouts.template.t16.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t16.footer')
</footer>
...
<!-- Bootstrap JS & Jquery -->
<script src="{{asset('assets/web/template/t16')}}/vendors/jquery/jquery.min.js"></script>
...
<script src="{{asset('assets/web/template/t16')}}/vendors/bootstrap/js/bootstrap.min.js"></script>
<script src="{{asset('assets/web/template/t16')}}/vendors/owl.carousel/js/owl.carousel.js"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t16')}}/js/main.js"></script>
<script src="{{asset('assets/web/template/t16')}}/js/header.js"></script>
