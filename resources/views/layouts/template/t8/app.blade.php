...
<head>
    ...
    <!-- Bootstrap  CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t8/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t8/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#FFC327'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#541726'}};
        }
    </style>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/plugins/css/plugins.bundle.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t8/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t8/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t8/css/responsive.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t8/css/custome.css')}}">
...
<body>
<header id="header">
    @include('layouts.template.t8.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t8.footer')
</footer>
...
<script src="{{asset('assets/web/template/t8/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t8/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t8/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t8/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t8/js/header.js')}}"></script>
