...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t21/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t21/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#14AB7E'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#C4AB7E'}};
        }
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t21/css/header_footer.css')}}">

    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t21/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t21/css/responsive.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t21/css/custome.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t21/css/edit.css')}}">
...
<header id="header1" class="fixed-top">
    @include('layouts.template.t21.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t21.footer')
</footer>
...
<script src="{{asset('assets/web/template/t21/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t21/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t21/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t21/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t21/js/header.js')}}"></script>
