...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t6/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t6/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#FF5D02'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#AF5D02'}};
        }
    </style>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/plugins/css/plugins.bundle.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t6/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t6/css/custome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t6/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t6/css/responsive.css')}}">
...
<body>
<header id="header">
    @include('layouts.template.t6.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t6.footer')
</footer>
...
<script src="{{asset('assets/web/template/t6/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t6/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t6/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t6/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t6/js/header.js')}}"></script>
