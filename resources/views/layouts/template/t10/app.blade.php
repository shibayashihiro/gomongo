...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t10/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t10/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#5BC8CC'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#0BC8CC'}};
        }
    </style>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/plugins/css/plugins.bundle.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t10/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t10/css/custome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t10/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t10/css/responsive.css')}}">
...
<header id="header" class="fixed-top">
    @include('layouts.template.t10.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t10.footer')
</footer>
...
<script src="{{asset('assets/web/template/t10/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t10/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t10/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t10/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t10/js/header.js')}}"></script>
