...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t3/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t3/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#00B92B'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#073B46'}};
        }
    </style>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/plugins/css/plugins.bundle.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t3/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t3/css/custome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t3/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t3/css/responsive.css')}}">
...
<body>
<header id="header">
    @include('layouts.template.t3.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t3.footer')
</footer>
...
<script src="{{asset('assets/web/template/t3/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t3/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t3/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t3/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t3/js/header.js')}}"></script>
