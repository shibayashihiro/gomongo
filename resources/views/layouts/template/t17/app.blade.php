...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t17/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t17/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#505AEB'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'##6952FE'}};
        }
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t17/css/header_footer.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t17/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t17/css/responsive.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t17/css/custome.css')}}">
...
<header id="header1" class="fixed-top">
    @include('layouts.template.t17.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t17.footer')
</footer>
...
<script src="{{asset('assets/web/template/t17/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t17/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t17/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t17/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t17/js/header.js')}}"></script>
