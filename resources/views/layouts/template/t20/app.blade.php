...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t20/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t20/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#6A52FE'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#32315C'}};
        }
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t20/css/header_footer.css')}}">

    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t20/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t20/css/responsive.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t20/css/custome.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t20/css/edit.css')}}">
...
<header id="header1" class="fixed-top">
    @include('layouts.template.t20.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t20.footer')
</footer>
...
<script src="{{asset('assets/web/template/t20/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t20/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t20/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t20/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t20/js/header.js')}}"></script>
