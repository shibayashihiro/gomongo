...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t19/vendors/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/web/template/t19/vendors/owl.carousel/css/owl.carousel.min.css')}}">
    <!-- Custome CSS -->
    <style>
        :root {
            --primary: {{(!empty($web_content->color))?$web_content->color:'#F38C08'}};
            --secondary: {{(!empty($web_content->secondary_color))?$web_content->secondary_color:'#000000'}};
        }
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t19/css/header_footer.css')}}">

    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t19/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t19/css/responsive.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t19/css/custome.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t19/css/edit.css')}}">
...
<header id="header1" class="fixed-top">
    @include('layouts.template.t19.header')
...
<!-- FOOTER -->
<footer id="footer">
    @include('layouts.template.t19.footer')
</footer>
...
<script src="{{asset('assets/web/template/t19/vendors/jquery/jquery.min.js')}}"></script>
...
<script src="{{asset('assets/web/template/t19/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/web/template/t19/vendors/owl.carousel/js/owl.carousel.js')}}"></script>
<!-- custome Jquery -->
<script src="{{asset('assets/web/template/t19/js/main.js')}}"></script>
<script src="{{asset('assets/web/template/t19/js/header.js')}}"></script>
