...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t16/css/wizard.css')}}">
@endsection
            ...
            <div class="wd-kr-bnr_title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Finanace Form</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <form class="wd-kr-wform" id="frmFinanceInvoice" name="frmFinanceInvoice" method="post"
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-step1" role="tabpanel"
                                    ...
                                    <div class="wd-kr-wizardbtn">
                                        <button type="button" class="wd-kr-cmmn-btn next-step"
                                ...
                                <div class="tab-pane fade" id="v-pills-step2" role="tabpanel"
                                    ...
                                    <div class="wd-kr-wizardbtn">
                                        <a href="javascript:;" class="wd-kr-backbtn prev-step"
                                           data-tab="#v-pills-step1-tab">
                                            <svg class="mr-1" width="25" height="16" viewBox="0 0 25 16" fill="none"
                                                ...
                                                <path d="M25 7H3.83L9.42 1.41L8 0L0 8L8 16L9.41 14.59L3.83 9H25V7Z"
                                                      fill="url(#paint0_linear_333_4370)"></path>
                                                <defs>
                                ...
                                <div class="tab-pane fade" id="v-pills-step3" role="tabpanel"
                                    ...
                                    <div class="wd-kr-wizardbtn">
                                        <a href="javascript:;" class="wd-kr-backbtn prev-step"
                                           data-tab="#v-pills-step2-tab">
                                            <svg class="mr-1" width="25" height="16" viewBox="0 0 25 16" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path d="M25 7H3.83L9.42 1.41L8 0L0 8L8 16L9.41 14.59L3.83 9H25V7Z"
                                                      fill="url(#paint0_linear_333_5826)"></path>
                                                <defs>
                                        ...
                                        <button type="submit" class="wd-kr-cmmn-btn next-step"
                                        ...
                                        <a href="javascript:;" class="wd-kr-backbtn prev-step"
                                           data-tab="#v-pills-step3-tab">
                                            <svg class="mr-1" width="25" height="16" viewBox="0 0 25 16" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path d="M25 7H3.83L9.42 1.41L8 0L0 8L8 16L9.41 14.59L3.83 9H25V7Z"
                                                      fill="url(#paint0_linear_333_6093)"></path>
                                                <defs>
                                ...
                                <div class="tab-pane fade" id="v-pills-step6" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Vehicle Price : <span
                                                        class="summery_vehicle_price"></span></label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Deposit Amount : <span
                                                        class="summery_deposit_amount"></span></label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Settlement Figure : <span
                                                        class="summery_settlement_figure"></span></label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Term of Agreement : <span
                                                        class="summery_term_of_agreement"></span></label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                    ...
                                    <div class="wd-kr-wizardbtn">
                                        ...
                                        <button type="submit" class="wd-kr-cmmn-btn" id="btnFinanceInvoice">Finish
                                        </button>
                                    </div>
                                </div>
                            </div>
