            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="wd-kr-srch-car-box">
                        <form class="form-inline wd-md-serach-car-form" name="frmSearch" id="frmSearch">
                            ...
                            <x-forms.price-selector :maxPrice="$max_price" page="stock-list"
                                parentClass="form-group price-filter" :hasLabel="false" />

                            <div class="mrlf_8 wd-kr-srch-car">
                                <button class="btn wd-kr-btn car-search-btn">Search Car</button>
                            </div>
                        </form>
                    </div>
                </div>

                {{-- <div class="wd-kr-search-btm-bx d-flex align-items-center justify-content-between mrgtb_44">
                    <h3>Displaying 1-06 Of 50 Vehicles</h3>
                    <form class="form-inline justify-content-between wd-kr-serach-car-form">
                        <select class="custom-select wd-kr-price">
