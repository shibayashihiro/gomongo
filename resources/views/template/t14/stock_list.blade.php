...
@section('content')
    ...
    <section class="wd-main-search-list-blog" id="stock_list">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <form name="frmSearch" id="frmSearch">
                        <div class="wd-sl-heading wd-sl-head_flex">
                            <h5>Filter</h5>
                            {{-- <a href="javascript:;"><svg width="25" height="20" viewBox="0 0 25 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M7.19365 4.83611C5.55525 6.47451 4.88974 8.75291 5.2224 10.9033L7.68009 10.084L5.8624 17.4824L0 12.6189L2.56 11.7741C1.92 8.65088 2.81607 5.27168 5.22231 2.86528C8.11515 -0.027565 12.3647 -0.718626 15.8975 0.740482L15.232 3.47959C12.6207 2.19959 9.36955 2.66048 7.19355 4.83639L7.19365 4.83611Z"
                                        fill="#F38C08" />
                                    <path
                                        d="M21.7594 7.83125C22.3994 10.9544 21.5033 14.3337 19.0971 16.7401C16.2042 19.6329 11.9547 20.324 8.42188 18.8649L9.08743 16.1257C11.6987 17.4057 14.9498 16.945 17.1258 14.7689C18.7642 13.1305 19.4297 10.8521 19.0971 8.70174L16.6394 9.52103L18.4571 2.12262L24.3195 6.98663L21.7594 7.83125Z"
                                        fill="#F38C08" />
                                    <defs>
                                        <linearGradient id="paint0_linear_341_8415" x1="7.94875" y1="17.4824"
                                            x2="7.94875" y2="-0.0001297" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#3C94FC" />
                                            <stop offset="1" stop-color="#0460E7" />
                                        </linearGradient>
                                        <linearGradient id="paint1_linear_341_8415" x1="16.3707" y1="19.6055"
                                            x2="16.3707" y2="2.12262" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#3C94FC" />
                                            <stop offset="1" stop-color="#0460E7" />
                                        </linearGradient>
                                    </defs>
                ...
                <div class="col-md-9">
                    ...
                    <div class="wd-sl-custome_pages">
                        <div class="col-md-12 d-flex pagination justify-content-center mb-5 stocks-pagination">
