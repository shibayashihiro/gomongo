...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t6/css/wizard.css') }}">
@endsection
...
@section('script')
    <script src="{{ asset('assets/web/template/t6/js/wizard.js') }}"></script>
