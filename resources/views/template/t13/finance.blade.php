...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{asset('assets/web/template/t13/css/wizard.css')}}">
@endsection
        ...
        <div class="container">
            <div class="wd-sl-bnr_title">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
                    ...
                    aliquip ex ea commodoconsequat. </p>
                    ...
                    <div class="col-md-3">
                        <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active" id="v-pills-step1-tab" data-toggle="pill" href="#v-pills-step1"
                               role="tab" aria-controls="v-pills-step1" aria-selected="true"><span>1. Personal Informations</span></a>
                            <a class="nav-link" id="v-pills-step2-tab" data-toggle="pill" href="#v-pills-step2"
                               role="tab" aria-controls="v-pills-step2" aria-selected="false"><span>2. Address Information</span></a>
                            <a class="nav-link" id="v-pills-step3-tab" data-toggle="pill" href="#v-pills-step3"
                               role="tab" aria-controls="v-pills-step3" aria-selected="false"><span>3. Employement Information</span></a>
                            <a class="nav-link" id="v-pills-step4-tab" data-toggle="pill" href="#v-pills-step4"
                               role="tab" aria-controls="v-pills-step4"
                               aria-selected="false"><span>4. Bank Details</span></a>
                            <a class="nav-link" id="v-pills-step5-tab" data-toggle="pill" href="#v-pills-step5"
                               role="tab" aria-controls="v-pills-step5" aria-selected="false"><span>5. Affordability Information</span></a>
                            <a class="nav-link" id="v-pills-step6-tab" data-toggle="pill" href="#v-pills-step6"
                               role="tab" aria-controls="v-pills-step6"
                               aria-selected="false"><span>6. Here is Summary</span></a>
                        </div>
                    </div>
                    <div class="col-md-9">
...
@section('script')
    <script src="{{asset('assets/web/template/t13/js/wizard.js')}}"></script>
    <script
