...
@section('content')
    <section id="banner">
        ...
        <div class="owl-home owl-carousel owl-theme">
            <div class="item">
                <img class="home_slider_slider_image_1 wd-sl-banner_car"
                ...
                <div class="wd-sl-home_panel">
                    <div class="wd-sl-panelinner banner-title">
            ...
            <div class="item">
                <img class="home_slider_slider_image_2 wd-sl-banner_car"
            ...
            <div class="item">
                <img class="home_slider_slider_image_3 wd-sl-banner_car"
        ...
        <div class="wd-sl-homefilter">
            <div class="wd-sl-srchlist-filter mb-0">
    ...
    <section id="welcome">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="wd-sl-banertitle position-relative text-left">
                        <h5 class="home_about_us_sub_title">
                        ...
                        {{-- <div class="wd-sl-commonbtn_main">
                            <a href="javascript:;" class="common-btn">Know more</a>
                        </div> --}}
                    </div>
                </div>
                <div class="col-md-7">
                    <img src="{{ asset(get_web_content_detail($web_content->id, $web_content->template, 'home', 'about_us', 'image')) }}"
                        class="home_about_us_image wd-sl-about_car">
                </div>
            </div>
        </div>
    </section>
    <section id="service">
        <div class="container">
            ...
            <div class="wd-sl-banertitle position-relative text-center">
                <h5 class="home_our_services_title">
    ...
    <section id="stock">
        <div class="container">
            ...
            @endif
            <div class="wd-sl-banertitle position-relative text-center">
                <h5 class="home_our_recent_stock_title">
            ...
            <div class="wd-sl-stocks_main wd-sl-stock_home stock_div">
                    ...
                    @foreach ($stocks as $key => $value)
                        ...
                        @endif --}}
                            <div class="wd-sl-stocks">
                                <a href="{{ route('front.template.stock_details', [$domain_slug, $value->id]) }}"><img
                                        src="{{ checkFileExist($stockImg) }}"></a>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="testimonial_div">
                        <div class="owl-review owl-carousel owl-theme">
                            @foreach ($web_content->testimonial as $testimonial)
                                <div class="item testimonial-item-{{ $testimonial->id }} wd-sl-commonbtn_main">
                            ...
                            @endforeach
                            <div class="item testimonial-item-new wd-sl-commonbtn_main">
                                <div class="wd-sl-reviewmain">

                                    <div class="wd-md-ser-img-o testi-action-prt">
                                        <a herf="javascript:;"
                ...
                <div class="col-md-6 my-auto text-right">
                    <img src="{{ asset('assets/web/template/t19/images/home/reviewimg.png') }}" class="wd-sl-review_img">
                </div>
            </div>
        </div>
    </section>
    <section id="other">
        <div class="container">
            <div class="wd-edit-plans">
                @if (is_login_for_edit() == 1)
                    <a class="wd-edit-btn" href="javascript:;"
                        onclick="getDynamicModal('{{ $web_content->id }}','{{ $web_content->template }}','home','offer',{{ json_encode(['Title' => 'text', 'Sub Title' => 'textarea']) }})">
                        <img src="{{ asset('assets/web/images/edit-btn.png') }}">
                    </a>
                @endif
            </div>
