...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t5/css/wizard.css') }}">
@endsection
    ...
    <div class="search-banner">
        <div class="container">
            <div class="banner-desc">
                <h1><span>Finanace Application Form</span></h1>
            </div>
...
@section('script')
    <script src="{{ asset('assets/web/template/t5/js/wizard.js') }}"></script>
