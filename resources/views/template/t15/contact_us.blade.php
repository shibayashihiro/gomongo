...
@section('style')
    <style>
        .wd-contact-blog p span.common_footer_address {
            width: 100%;
        }
    </style>
@endsection
...
@section('content')
    ...
    <section class="wd-open-form-blog" id="contact">
            ...
            <div class="row">
                        ...
                        <form class="wd-sl-cform" id="frmContactInvoice" name="frmContactInvoice" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 text-center mt-3">
                                    <button class="wd-get-in-btn" id="btnSubmit" type="submit">Get in touch</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="wd-contact-blog">
                        ...
                        <h5>Contact Details
                            <svg width="60" height="3" viewBox="0 0 60 3" fill="none"
                                ...
                                <rect width="60" height="3" fill="#60BC4C" />
                            </svg>
                        </h5>
                        <p>
                            <a
                    ...
                    <div class="wd-md-opening-hours wd-contact-opening-hours">
                        {{-- <div class="wd-kr-contactedit-btm">
                            <a class="wd-edit-btn" href="javascript:;"><img src="assets/images/edit.png"></a>
                        </div> --}}
