...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t15/css/wizard.css') }}">
@endsection
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class="disabled">
                            <a href="#step3" data-toggle="tab" aria-controls="step3" role="tab"><span
                                    class="round-tab">3</span> <i>Employement Information</i></a>
                        </li>
                        <li role="presentation" class="disabled">
                    ...
                    <div class="tab-content" id="main_form">
                        <div class="tab-pane active" role="tabpanel" id="step1">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div
                                        class="form-group wd-gender-radio d-flex align-items-center justify-content-between">
                                        <label class="wd-label-title">Gender</label>
...
@section('script')
    <script src="{{ asset('assets/web/template/t15/js/wizard.js') }}"></script>
