    ...
    <div class="search-banner">
        <div class="container">
            ...
            <div class="banner-desc">
                ...
                <p>With a wide variety of stock, we are confident we can help you in finding your dream car! Have a
                    look at our diverse stock portfolio and contact us to book a viewing or test drive!</p>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="car-right">
                                                <div class="search-card-head">
                                                    <div class="pd-name-row">
                                                        ...
                                                        <div class="price-box">£{{ number_format($value->price) }}</div>
                                                    </div>
                                                </div>
                                                <div class="search-category">
                                                    ...
                                                    <div class="cat-box">
                                                        <p>TRANSMISSION:</p>
                                                        <strong>{{ $value->transmission }}</strong>
                                                    </div>
                                                </div>
                                                <div class="search-category">
                                                    <div class="cat-box">
                                                                    ...
                                                                    <div class="f-name">
                                                                        <svg width="22" height="14"
                                                                            ...
                                                                            <path
                                                                                ...
                                                                                fill="var(--primary)" />
                                                                            <rect x="2.5022" y="9.67188"
                                                                                width="0.731899" height="3.66993"
                                                                                fill="white" />
                                                                            <rect x="5.43018" y="6.66016"
                                                                                width="0.731899" height="7.01997"
                                                                                fill="white" />
                                                                            <rect width="0.731899" height="10.0085"
                                                                                transform="matrix(-1 0 0 1 9.0896 3.65234)"
                                                                                fill="white" />
                                                                            <rect x="11.2854" y="2.54297"
                                                                                width="0.731899" height="11.0098"
                                                                                fill="white" />
                                                                            <rect x="14.2131" y="1.80859"
                                                                                width="0.731899" height="11.7438"
                                                                                fill="white" />
                                                                            <rect x="17.1406" y="3.27344"
                                                                                width="0.731899" height="10.2758"
                                                                                fill="white" />
                                                                            <rect x="20.0681" y="4.74219"
                                                                                width="0.731899" height="8.80784"
                                                                                fill="white" />
                                                                        </svg>
                                                                        <p>Model</p>
