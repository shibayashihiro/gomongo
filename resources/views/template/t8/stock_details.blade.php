        ...
        <div class="container">
            <nav aria-label="breadcrumb" class="brdmb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Stock List Details</li>
                </ol>
            </nav>
            <div class="banner-desc">
                <h1><span>Stock List Details</span></h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="right-phone-number">
                        ...
                        <h6 class="common_footer_contact_number"><i class="fa fa-phone"></i>
                            &nbsp;{{ get_web_content_detail($web_content->id, $web_content->template, 'common', 'footer', 'contact_number') }}
                        </h6>
