...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t17/css/wizard.css') }}">
@endsection
...
@section('content')
    ...
    <section class="signup-step-container wd-kr-wizard">
        <div class="container">
            <div class="wizard">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" aria-expanded="true"
                                class="active">
                                <span class="round-tab">1 </span> <i>Personal Informations</i></a>
                            <div class="connecting-line-active"></div>
                        </li>
                        <li role="presentation" class="disabled">
                            <a href="#step2" data-toggle="tab" aria-controls="step2" role="tab" aria-expanded="false"
                                class="" aria-selected="false"><span class="round-tab">2</span> <i>Address
                                    Information</i></a>
                        </li>
                        <li role="presentation" class="disabled">
                            <a href="#step3" data-toggle="tab" aria-controls="step3" role="tab"
                                aria-selected="true"><span class="round-tab">3</span> <i>Employement Information</i></a>
                        </li>
                        <li role="presentation" class="disabled">
                            <a href="#step4" data-toggle="tab" aria-controls="step4" role="tab"><span
                                    class="round-tab">4</span> <i>Bank Details</i></a>
                        </li>
                        <li role="presentation" class="disabled">
                            <a href="#step5" data-toggle="tab" aria-controls="step5" role="tab"><span
                                    class="round-tab">5</span> <i>Affordability Information</i></a>
                        </li>
                        <li role="presentation" class="disabled">
                            <a href="#step6" data-toggle="tab" aria-controls="step6" role="tab"><span
                                    class="round-tab">6</span> <i>Here is Summary</i></a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="tab-content" id="main_form">
                        <div class="tab-pane active" role="tabpanel" id="step1">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="wd-gender-radio d-flex align-items-center justify-content-between">
                                        <label>Gender</label>
                                        <div class="form-check-inline custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="male"
                                                name="gender" value="male" onchange="preview_update('gender')">
                                            <label class="custom-control-label" for="male">Male</label>
                                        </div>
                                        <div class="form-check-inline custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="female"
                                                name="gender" value="female" onchange="preview_update('gender')">
                                ...
                                <div class="col-md-4">
                                    <select class="custom-select wd-marital-status form-control" name="marital_status"
                                        id="marital_status" onchange="preview_update('marital_status')">
...
@section('script')
    <script src="{{ asset('assets/web/template/t17/js/wizard.js') }}"></script>
    ...
    <script>
        ...
        function preview_update(element) {
            if (element === 'marital_status') {
                $(".summery_" + element).html($("#marital_status").val());
