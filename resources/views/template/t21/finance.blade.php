...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t21/css/wizard.css') }}">
@endsection
    ...
    <section id="wizard">
        <div class="container">
            <div class="wizard">
                ...
                <form class="login-box" id="frmFinanceInvoice" name="frmFinanceInvoice" method="post" action="javascript:;"
...
@section('script')
    <script src="{{ asset('assets/web/template/t21/js/wizard.js') }}"></script>
