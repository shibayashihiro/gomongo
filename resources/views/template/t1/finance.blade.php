...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t1/css/wizard.css') }}">
    <style>
        #frmFinanceInvoice .form-group {
            margin-bottom: 30px;
        }
    </style>
@endsection
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab"
                                aria-expanded="true"><span class="round-tab">1 </span> <i>Personal<br>
                                    Informations</i></a>
                        </li>
                    ...
                    <div class="tab-content" id="main_form">
                        <div class="tab-pane active" role="tabpanel" id="step1">
                            ...
                            <ul class="list-inline pull-right">
                                {{-- <li><button type="button" class="default-btn prev-step">Save</button></li> --}}
                                <li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step6">
                            ...
                            <ul class="list-inline pull-right">
                                ...
                                <li>
                                    <button id="btnFinanceInvoice" type="button" class="default-btn next-step">Finish
                                    </button>
                                </li>
                            </ul>
                        </div>
...
@section('script')
    <script src="{{ asset('assets/web/template/t1/js/wizard.js') }}"></script>
