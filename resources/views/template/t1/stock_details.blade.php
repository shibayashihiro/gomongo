                    ...
                    <div class="wd-details-bg">
                        ...
                        <div class="wd-car-details-content">
                            ...
                            <div class="wd-car-dt-btn">
                                <ul>
                                    <li><a href="mailto:{{ $stock->user->email }}?subject=Help%20Me&body=Hi%0AI%20am%20interested%20in%20({{$stock->registration}}).aa%20I%20would%20like%20to%20reserve%20it%20for%20({{date('Y-m-d')}})%20at%20({{date('H:i:s')}})%0ARegards%0A">Book a test drive</a></li>
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                <div class="col-6 col-lg-2 pl-0">
                                    <div class="wd-key-fact-text">
                                        <p>Model Year: <span>{{ $stock->manufacture }}</span>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-6 col-lg-2 pl-0">
