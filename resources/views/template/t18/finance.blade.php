...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t18/css/wizard.css') }}">
@endsection
    ...
    <section class="wd-stock-list-main-blog">
        <div class="container">
            <div class="wd-stock-list-title">
                <h1>Finanace Application Form</h1>
...
@section('script')
    <script src="{{ asset('assets/web/template/t18/js/wizard.js') }}"></script>
