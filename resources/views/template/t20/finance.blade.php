...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t20/css/wizard.css') }}">
@endsection
                ...
                <form class="wd-sl-wform" id="frmFinanceInvoice" name="frmFinanceInvoice" method="post"
                    ...
                    <div class="tab-content" id="main_form">
                        <div class="tab-pane active" role="tabpanel" id="step1">
                            <h2 class="wd-step-title">Personal informations</h2>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                            <h2 class="wd-step-title">Address information</h2>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                        ...
                        <div class="tab-pane" role="tabpanel" id="step3">
                            <h2 class="wd-step-title">Employement information</h2>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                        ...
                        <div class="tab-pane" role="tabpanel" id="step4">
                            <h2 class="wd-step-title">Bank Details</h2>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                        ...
                        <div class="tab-pane" role="tabpanel" id="step5">
                            <h2 class="wd-step-title">Affordability Information</h2>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
...
@section('script')
    <script src="{{ asset('assets/web/template/t20/js/wizard.js') }}"></script>
