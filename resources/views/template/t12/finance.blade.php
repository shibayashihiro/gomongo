...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t12/css/wizard.css') }}">
@endsection
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab"
                                aria-expanded="true"><span class="round-tab">1 </span> <i>Personal Informations</i></a>
                        </li>
                        <li role="presentation" class="disabled">
                            <a href="#step2" data-toggle="tab" aria-controls="step2" role="tab"
                                aria-expanded="false"><span class="round-tab">2</span> <i>Address Information</i></a>
                        </li>
                        <li role="presentation" class="disabled">
...
@section('script')
    <script src="{{ asset('assets/web/template/t12/js/wizard.js') }}"></script>
