...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t2/css/wizard.css') }}">
@endsection
...
@section('content')
    <section class="wd-md-stock-main">
        <div class="container">
            ...
            <h2>Finanace Application Form</h2>
            ...
            <div class="wizard">
                <div class="wizard-inner">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class="step-active disabled">
                        ...
                        <li role="presentation" class="step-active disabled">
                            <a href="#step6" data-toggle="tab" aria-controls="step6" role="tab"><span
                                    class="round-tab">6</span> <i>Here is<br> Summary</i></a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="tab-content" id="main_form">
                        <div class="tab-pane active" role="tabpanel" id="step1">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <select class="form-control" name="gender" onchange="preview_update('gender')">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input class="form-control" type="number" name="no_dependant"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="driving_licence"
                                            placeholder="Driving Licence" onchange="preview_update('driving_licence')">
                                    </div>
                                </div>
                            </div>
                            <ul class="list-inline pull-right">
                                {{-- <li><button type="button" class="default-btn next-step">Next</button></li> --}}
                                <li><button type="button" class="default-btn next-step" id="btnNextOne">Next</button>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" id="emp_address" name="emp_address"
                                            placeholder="Pincode Lookup" onchange="preview_update('emp_address')">
                                    </div>
                                    <div id="emp_address_div">
                                        <input type="hidden" data-geo="lat" value="" id="emp_latitude"
                                            name="emp_latitude">
                                        <input type="hidden" data-geo="lng" value="" id="emp_longitude"
                                            name="emp_longitude">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" id="emp_postcode" name="emp_postcode"
                        ...
                        <div class="tab-pane" role="tabpanel" id="step5">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Do you foresee a downturn in your financial position during the term of this
                                            agreement(including any Covid-19 related impact?</label>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step6">
                            ...
                            <ul class="list-inline pull-right">
                                ...
                                <li><button type="button" class="default-btn prev-step">Back</button></li>
                                <li><button id="btnFinanceInvoice" type="button"
...
@section('script')
    <script src="{{ asset('assets/web/template/t2/js/wizard.js') }}"></script>
