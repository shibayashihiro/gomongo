...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/template/t11/css/wizard.css') }}">
    <style>
        .wd-sl-wizard .form-control {
            color: #000000;
        }
    </style>
@endsection
                    ...
                    <div class="tab-content" id="main_form">
                        ...
                        <div class="tab-pane" role="tabpanel" id="step6">
                            ...
                            <ul class="list-inline pull-right">
                                ...
                                <li>
                                    <button type="button" class="default-btn next-step" id="btnFinanceInvoice">Finish
                                    </button>
                                </li>
                            </ul>
                        </div>
