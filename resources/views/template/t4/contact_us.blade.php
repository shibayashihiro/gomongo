            ...
            <div class="row wd-sl-width">
                <div class="col-md-6">
                    <div class="contact-card">
                        ...
                        @if (is_login_for_edit() == 1)
                            <a class="wd-edit-btn" href="javascript:;"
                                onclick="getDynamicModal('{{ $web_content->id }}','{{ $web_content->template }}','contact_us','middle_content',{{ json_encode([
                                    'Landline' => 'text',
                                    'Email' => 'text',
                                    'Address' => 'text',
                                ]) }})"><img
                        ...
                        <div class="wd-sl-ph">
                            <span>Landline : </span>
                            <a href="javascript:;"
                                class="contact_us_middle_content_landline">{{ get_web_content_detail($web_content->id, $web_content->template, 'contact_us', 'middle_content', 'Landline') }}</a>
                        </div>
                        <div class="wd-sl-ph">
                            <span class="mb-0">Email : </span>
                            <a href="javascript:;"
                                class="contact_us_middle_content_email">{{ get_web_content_detail($web_content->id, $web_content->template, 'contact_us', 'middle_content', 'email') }}</a>
                        </div>
                    </div>
                    <div class="contact-card">
                        <h6>
                        ...
                        <div class="wd-sl-ph">
                            <span
                                class="contact_us_middle_content_address">{{ get_web_content_detail($web_content->id, $web_content->template, 'contact_us', 'middle_content', 'address') }}</span>
