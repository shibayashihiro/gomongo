...
<div
    ...
    <table>
        <thead>
        <tr>
            <th style="width: 75%;background-color: #0AACDD;height: 30px;"></th>
            <th style="line-height: 37px;font-size: 40px;font-weight: 400;text-align: center;">INVOICE</th>
            <th style="width: 6%;background-color: #0AACDD;height: 30px;"></th>
        </tr>
        </thead>
    </table>
    <div class="row">
        <div class="column">
            <table style="width: 99%;margin-right: auto;">
                <thead
                    style="background: #F8F8F8;border: 1px solid rgba(0, 0, 0, 0.1);box-sizing: border-box;padding: 0 10px;width: 100%;">
                <tr>
                    <th style="font-size: 12px;font-weight: 500;border-bottom: 1px solid #ccc;padding: 10px 10px;margin-bottom: 10px;text-align: left;">
                        Vehicle Detail
                    </th>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 8px 10px 4px;">VRN
                        : {{$registration_number}}</td>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 8px 10px 4px;">Vehicle Make and
                        Model: {{$model}}</td>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 8px 10px 4px;">Mileage : {{$mileage}}</td>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 8px 10px 4px;">Vehicle Color :{{$color}}</td>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 8px 10px 4px;">Engine Size
                        : {{$engine_size}}</td>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 8px 10px 4px;">Engine Number
                        :{{$engine_number}}</td>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 8px 10px 4px;">Date of Registration
                        :{{$date_registration}}</td>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 8px 10px 4px;">Vin Number :{{$vin_number}}</td>
                </tr>
                </thead>
            </table>
        </div>
        <div class="column" style="padding: 0px 0 0;">
            <table style="width: 99%;margin-left: auto;">
                <thead style="text-align: right;margin-left: auto;">
                <tr>
                    <th style="border: none;font-size: 14px;font-weight: 600;margin-bottom: 0;text-align: right;padding: 0px 0 8px;">
                        {{ucfirst($type)}} Receipt
                    </th>
                </tr>
                <tr>
                    <td style="padding-bottom: 4px;font-size: 12px;">{{$vendor_address}}</td>
                </tr>
                <tr>
                    <td style="padding-bottom: 4px;font-size: 12px;">{{$vendor_email}} | {{$vendor_mobile}}</td>
                </tr>
                <tr>
                    <td style="padding-bottom: 10px;font-size: 12px;">{{$vendor_website}}</td>
                </tr>
                </thead>
                <thead
                    style="background: #F8F8F8;border: 1px solid rgba(0, 0, 0, 0.1);box-sizing: border-box;padding: 0px 10px;width: 100%;text-align: left;">
                <tr>
                    <th style="font-size: 12px;font-weight: 500;border-bottom: 1px solid #ccc;padding: 10px 10px;margin-bottom: 10px;text-align: left;">
                        Customer Detail
                    </th>
                ...
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 8px 10px 4px;">Name : {{$customer_name}}</td>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 4px 10px 20px;">Address
                        : {{$house_number.', '.$address.'-'.$postcode}}</td>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 4px 10px 8px;">Email ID :{{$email}}</td>
                </tr>
                <tr>
                    <td style="font-size: 11px;color: #545454;padding: 4px 10px 8px;">Contact No
                        :{{$contact_number}}</td>
                </tr>
                </thead>
            </table>
    ...
    <table class="wd-sl-total">
        ...
        <tr style="background-color: #0AACDD;">
            <td style="font-size: 12px;font-weight: 600;color: #fff;padding: 14px 20px;" colspan="2">Total Outstanding
                (To be
                paid)
            </td>
        ...
        <table class="wd-sl-text">
            ...
            <tr>
                <td>2. In the event of the vehicle being faulty, or having any mechanical issues, which are covered by
                    ...
                    {{$vendor_trading_name}}, the customer would be responsible for notifying
                    {{$vendor_trading_name}}. If the customer decides to address the fault/mechanica issue privately,
